 ...
 *  
 */
public class AdapterMarkdown extends RecyclerView.Adapter<AdapterMarkdown.VH> {
    private ArrayList<MarkDown> items;
    ...
    public AdapterMarkdown(Context context, ArrayList<MarkDown> items) {
        this.items = items;
    ...
    public void onBindViewHolder(@NonNull VH holder, final int position) {
        ...
        holder.markdownView.loadMarkdown(markDown.getContent());
